...
if(!body.player) 
return message.channel.send(`I can't find this users`);

if(!body.player.lastLogin) 
return console.log("Error");
if(!body.player.firstLogin) 
return console.log("Error");
